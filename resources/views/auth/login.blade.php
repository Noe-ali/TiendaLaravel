            ...
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                    <div class="cursor-pointer flex items-center">
                        ...
                        <div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">Tienda</div>
                    </div>
                </div>
                <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    <h2 class="text-center text-4xl text-indigo-900 font-display font-semibold lg:text-left xl:text-5xl
                    xl:text-bold">Iniciar Sesión</h2>
                    <div class="mt-12">
                        <form method="POST" action="{{ route('login') }}">
                        @csrf
                            <div>
                                <div class="text-sm font-bold text-gray-700 tracking-wide">Dirección de correo</div>
                            ...
                            <div class="mt-8">
                                ...
                                <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" id="password"  type="password" name="password" required autocomplete="current-password"  placeholder="Ingresa tu contraseña">
                            </div>
                            <div class="mt-10">
                        ...
                        <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                            ¿Aún no tienes una cuenta? ? <a class="cursor-pointer text-indigo-600 hover:text-indigo-800" href="{{ route('register') }}">Registrarse</a>
                        </div>
                    </div>
                </div>
            </div>
